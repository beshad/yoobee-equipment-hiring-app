...
//! author : Werner Mollentze : https://github.com/wernerm
    var _ = (a.defineLocale("af", {
        ...
        week: {dow: 0, doy: 6}
    }), "styczeń_luty_marzec_kwiecień_maj_czerwiec_lipiec_sierpień_wrzesień_październik_listopad_grudzień".split("_")), Va = "stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_września_października_listopada_grudnia".split("_"), Wa = (a.defineLocale("pl", {
        months: function (a, b) {
        ...
        week: {dow: 1, doy: 7}
    }), [/^янв/i, /^фев/i, /^мар/i, /^апр/i, /^ма[й|я]/i, /^июн/i, /^июл/i, /^авг/i, /^сен/i, /^окт/i, /^ноя/i, /^дек/i]), Xa = (a.defineLocale("ru", {
        months: {
    ...
    }), "január_február_marec_apríl_máj_jún_júl_august_september_október_november_december".split("_")), Ya = "jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec".split("_"), Za = (a.defineLocale("sk", {
        months: Xa,
        monthsShort: Ya,
        ...
        week: {dow: 1, doy: 4}
    }), "pagh_wa’_cha’_wej_loS_vagh_jav_Soch_chorgh_Hut".split("_")), cb = (a.defineLocale("tlh", {
